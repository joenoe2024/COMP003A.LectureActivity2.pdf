namespace COMP003A.LectureActivity2.pdf
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("What is your name"); //request for a user input
            ...
            /* working with varibale integers*/
            ...
            /* reading froma a varibale does not change it*/
            int a;
            int b;
             ...
             * there are eight integer types for storing integers of differing sizes and ranges: int, short, long, sbyte, uint, ushort, ulong.
             ...
             * using var for a varibale's type tells the compiler to infer its type from the surrounding code, so you do not have to type it out. (but still has a specific type.)
            ...
            Console.WriteLine($"Concatenation using string interpolation : {aLetter} {message} "); // use string interpolation witha dollar-sign ($) before the opening double-quote and enclosing variables with curly braces ({variableName})
            ...
            Console.WriteLine($"New value of arithmetic2: {arithmetic1}");
            ...
            compoundAssignmentOperator += 5; // The equivalent of compoundAssignmentOperator = compoundAssignmentOperator -2; (a is 3 after this line runs.)
            ...
            incrementDecrementOperators++; //The equivalent of incrementDecrementOperators += 1; or incrementDecrementOperators = incrementDecrementOperators = incrementDecrementOperators + 1;
            ...
            // result: what is your name, human? jonathen
            ...
            Console.Beep(440, 1000); // computerbeeps
